...
export const AttrFilter = (props) => {
  ...
  return (
    <div className="text-xs mt-4" onChange={handleChange}>
      <h3 className="font-bold px-2 text-gray-100 uppercase mb-2">
        Attributes
      </h3>
      <div className="px-2">
        {filters.map((filter) => (
          <a
            className={`bg-gray-900 hover:bg-gray-300 rounded-md cursor-pointer text-gray-800 py-2 px-1 w-full flex`}
