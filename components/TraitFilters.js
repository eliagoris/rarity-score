...
export const TraitFilters = () => {
  ...
  return (
    <div className="flex flex-wrap mt-4 mb-4">
      {traits.length > 0 && (
        <div className="max-w-max	flex justify-center items-center m-1 font-medium py-1 pr-2 bg-gray-900 text-gray-500">
          <span className="text-xs">Filters:</span>
        </div>
      )}
      {traits.map((trait) => (
        <div className="max-w-max	flex justify-center items-center m-1 font-medium py-1 px-2 bg-gray-900 rounded-full text-indigo-700 bg-indigo-200">
      ...
      {attr_count && (
        <div className="max-w-max	flex justify-center items-center m-1 font-medium py-1 px-2 bg-gray-900 rounded-full text-indigo-100 bg-indigo-700 border border-indigo-700">
